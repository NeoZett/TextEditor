...
{
    enum class ShareWindowCommand : std::int32_t
    {
        None = 0,
        StartSharing = 1,
        StopSharing = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::UI::Shell::IFocusSessionManager>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_IsFocusActive(bool*) noexcept = 0;
            virtual std::int32_t __stdcall GetSession(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall TryStartFocusSession(void**) noexcept = 0;
            virtual std::int32_t __stdcall TryStartFocusSession2(std::int64_t, void**) noexcept = 0;
            virtual std::int32_t __stdcall DeactivateFocus() noexcept = 0;
            virtual std::int32_t __stdcall add_IsFocusActiveChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_IsFocusActiveChanged(winrt::event_token) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::UI::Shell::IShareWindowCommandEventArgs>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_WindowId(struct struct_Windows_UI_WindowId*) noexcept = 0;
            virtual std::int32_t __stdcall get_Command(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_Command(std::int32_t) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::UI::Shell::IShareWindowCommandSource>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall ReportCommandChanged() noexcept = 0;
            virtual std::int32_t __stdcall add_CommandRequested(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_CommandRequested(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_CommandInvoked(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_CommandInvoked(winrt::event_token) noexcept = 0;
        };
    };
