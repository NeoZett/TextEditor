...
void* __stdcall winrt_get_activation_factory([[maybe_unused]] std::wstring_view const& name)
{
    ...
    if (requal(name, L"TextEditor.MainWindow"))
    {
        return winrt_make_TextEditor_MainWindow();
    }

    if (requal(name, L"TextEditor.XamlMetaDataProvider"))
    {
        return winrt_make_TextEditor_XamlMetaDataProvider();
    }
